...
class EquipmentEditScreen extends StatefulWidget {
  static const String idScreen = "EquipmentEditScreen";
  ...
  @override
  _EquipmentEditScreen createState() => _EquipmentEditScreen();
}

class _EquipmentEditScreen extends State<EquipmentEditScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          title: Text("Equipment Registration Update"),
        ),
  ...
  void insertData(
   ...
   //   await firestore.collection("equipments1").add({
      await firestore.collection("equipments1").doc(widget.id.toString()).update({
    ...
    CoolAlert.show(
      ...
      text: 'Data Update Successful!',
          ...
          Navigator.pushNamedAndRemoveUntil(
              context, EquipmentListScreen.idScreen, (route) => true)
        });
  }
}
