...
class VehicleScreen extends StatefulWidget {
  static const String idScreen = "VehicleScreen";

  @override
  _VehicleScreen createState() => _VehicleScreen();
}
...
class _VehicleScreen extends State<VehicleScreen> {
 ...
 // TextEditingController districtTextEditingController = TextEditingController();
  ...
  TextEditingController nearestTownTextEditingController =
      ...
      taskSnapshot.ref.getDownloadURL().then((imageUrl) {
        ...
        if (_imageFile1 != null) {
          ...
          final Reference storageReference1 = FirebaseStorage.instance
              .ref()
              .child('Images')
              .child(imageFileName1);

          final UploadTask uploadTask1 =
              storageReference1.putFile(_imageFile1!);
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                      ...
                      if (nameTextEditingController.text.length < 3) {
                      ...
                      } else if (nearestTownTextEditingController
                          .text.isEmpty) {
                        displayToastMessage(
                            "Nearest Town is Required!", context);
                        ...
                        displayToastMessage(
                            "Select Vehicle Category!", context);
    ...
    try {
      await firestore.collection("vehicles1").add({
        ...
        'userid': storage.getItem("userid")
            ...
            lng = "",
            vehicleCategory = "",
            seatsTextEditingController.text = "",
            _imageFile = null,
            _imageFile1 = null,
            setState(() {
              _loading = false;
