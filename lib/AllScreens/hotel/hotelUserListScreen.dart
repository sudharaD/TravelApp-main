...
class HotelUserListScreen extends StatefulWidget {
  static const String idScreen = "HotelUserListScreen";

  @override
  _HotelUserListScreen createState() => _HotelUserListScreen();
}

class _HotelUserListScreen extends State<HotelUserListScreen> {
         ...
         Expanded(
          child: ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                print( 'printdata '+index.toString());
