...
class HotelViewScreen extends StatefulWidget {
  static const String idScreen = "HotelViewScreen";

  final String name,address,province,district,city,nearestTown,email,phone,dis,lat,lng,pic,pic1;
  HotelViewScreen({required this.name,required this.address,required this.province,required this.district,required this.city,required this.nearestTown,required this.email,required this.phone,required this.dis,required this.lat,required this.lng,required this.pic,required this.pic1}): super();

  @override
  _hotelViewScreen createState() => _hotelViewScreen();
}

class _hotelViewScreen extends State<HotelViewScreen> {
